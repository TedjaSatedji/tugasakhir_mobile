...
async def extract_receipt(file: UploadFile = File(...)):
    ...
    prompt = (
        "You are extracting receipt/income/transfer information from an image. "
        ...
        "CRITICAL FOR TRANSFERS: If the image shows 'Transfer to', 'Payment Sent', 'Paid to', or money going OUT to someone else, set type as 'expense'. "
        "If it shows 'Received from', 'Transfer from', or money coming IN, set type as 'income'. "
        "Assume by default that a proof of payment/transfer receipt generated by the user sending money is an 'expense'. "
